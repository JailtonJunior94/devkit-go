...
type Metrics interface {
	...
	// HistogramWithBuckets returns a histogram with custom bucket boundaries.
	// Buckets define the boundaries for histogram buckets (e.g., [0.1, 0.5, 1.0, 5.0]).
	// If not supported by the provider, falls back to default buckets.
